...
exec('npm view embed-brb version', (err, stdout) => {
  if (err) return; // Tránh làm gián đoạn nếu lỗi

  const latestVersion = stdout.trim();
  if (version !== latestVersion) {
    console.warn(`\x1b[33m[embed-brb] CẢNH BÁO: Bạn đang dùng phiên bản \x1b[31m${version}\x1b[33m đã lỗi thời hoặc đã được sửa đổi. Vui lòng cập nhật phiên bản mới nhất \x1b[32m${latestVersion}\x1b[33m.\x1b[33m bằng lệnh:\x1b[33m`);
    console.warn(`\x1b[36m> npm i embed-brb@latest\x1b[0m`);
    console.warn(`\x1b[33mHoặc truy cập: https://www.npmjs.com/package/embed-brb để xem thông tin mới nhất.\x1b[0m`);
  }
});


// if (compareVersions(version, REQUIRED_VERSION) < 0) {
//     console.warn(`\x1b[33m[embed-brb] CẢNH BÁO: Bạn đang dùng phiên bản ${version} đã lỗi thời. Vui lòng cập nhật bằng lệnh:\x1b[0m`);
//     console.warn(`\x1b[36m> npm i embed-brb@latest\x1b[0m`);
//     console.warn(`\x1b[33mHoặc truy cập: https://www.npmjs.com/package/embed-brb để xem thông tin mới nhất.\x1b[0m`);
// }