    ...
    async execute(interaction) {
        ...
        if (interaction.customId && interaction.customId.startsWith('ticketModal')) {
            ...
            if (!data) {
                ...
                if (!pingStaffData) {
                    return await interaction.reply({ content: `🚫 Không tìm thấy thông tin vai trò trong hệ thống. Hãy dùng lệnh ***ping_staff manage*** để setup 2 vai trò cho vé discord và vé valheim.`, ephemeral: true });
                }
